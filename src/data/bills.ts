...
export const categories = [
  ...
  { id: 'emi', name: 'EMI', icon: '🏠', color: 'bg-purple-100 text-purple-800' },
  { id: 'loan', name: 'Loan', icon: '🏦', color: 'bg-red-100 text-red-800' },
  { id: 'credit-card', name: 'Credit Card', icon: '💳', color: 'bg-indigo-100 text-indigo-800' },
  { id: 'internet', name: 'Internet', icon: '📡', color: 'bg-cyan-100 text-cyan-800' },
  { id: 'phone', name: 'Phone', icon: '📱', color: 'bg-green-100 text-green-800' },
